...
// The hint text ships with a placeholder domain; swap in the configured one.
function renderDomainHints(domain) {
  if (!domain) return;
  document.querySelectorAll(".auto-address").forEach((el) => {
...
async function loadSettings() {
  ...
  renderFromList(settings);
  renderDomainHints(settings.domain);
}
